...
public class NetworkImageView extends ImageView {
	...
	private ImageSetupListener mImageSetupListener;
	...
	public void setDefaultBackroundId(int defaultBackgroundId) {
		this.mDefaultBackgroundId = defaultBackgroundId;
	}
	...
	public void setErrorBackgroundResId(int errorBackground) {
		this.mErrorBackground = errorBackground;
	}

	public ImageSetupListener getmImageSetupListener() {
		return mImageSetupListener;
	}

	public void setmImageSetupListener(ImageSetupListener mImageSetupListener) {
		this.mImageSetupListener = mImageSetupListener;
	}
				...
				new ImageListener() {
					...
					public void onErrorResponse(VolleyError error) {
						if (mErrorBackground != 0) {
							setBackgroundResource(mErrorBackground);
						}
						if (mErrorImageId != 0) {
							setImageResource(mErrorImageId);
						}
						if (mImageSetupListener != null) {
							mImageSetupListener.onErrorResponse(error);
						}
					}
					...
					public void onResponse(final ImageContainer response,
						...
						if (response.getBitmap() != null) {
							...
							if (mDefaultBackgroundId != 0) {
								setBackgroundResource(mDefaultBackgroundId);
							}
						}
						if (mImageSetupListener != null) {
							mImageSetupListener.onResponse(response,
									isImmediate);
						}
					}
				});
	...
	private void setDefaultImageOrNull() {
		...
		if (mImageSetupListener != null) {
			mImageSetupListener.onDefaultsSet();
		}
	}
	...
	public interface ImageSetupListener extends ImageListener {

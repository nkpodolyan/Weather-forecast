...
/**
 * A {@link View.OnTouchListener} that makes the list items in a {@link ListView} dismissable. {@link ListView} is given
 * special treatment because by default it handles touches for its list items... i.e. it's in charge of drawing the
 * pressed state (the list selector), handling list item clicks, etc.
 * 
 * <p>
 * After creating the listener, the caller should also call
 * {@link ListView#setOnScrollListener(AbsListView.OnScrollListener)}, passing in the scroll listener returned by
 * {@link #makeScrollListener()}. If a scroll listener is already assigned, the caller should still pass scroll changes
 * through to this listener. This will ensure that this {@link SwipeDismissListViewTouchListener} is paused during list
 * view scrolling.
 * </p>
 * 
 * <p>
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
	 ...
	 * @param callbacks
	 *            The callback to trigger when the user has indicated that she would like to dismiss one or more list
	 *            items.
	 */
